...
export class CreateUserAndWealthTables1708724126227 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "twitch"."wealth" ADD CONSTRAINT "FK_0ab7b20a87c3f9f5ea4fa14339d" FOREIGN KEY ("user_id") REFERENCES "twitch"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
